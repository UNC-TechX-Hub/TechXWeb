        ...
        <div style={{ 
          ...
          <div style={{
            ...
            <div style={{ 
              ...
              <a
                href="https://www.linkedin.com/company/techx-unc/"
                target="_blank"
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.filter = 'drop-shadow(0 0 20px rgba(56, 182, 255, 0.6))';
                }}
                onMouseLeave={(e) => {
              ...
              <a
                href="https://heellife.unc.edu/organization/unctechx"
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  color: '#FFFFFF',
